...
export default function ModifieClient () {
    ...
    return (
        <form className="grid lg:grid-cols-2 w-5/7 gap-5" onSubmit={handleSubmit}>
            ...
            <div className="input-type">
                <input className="w-[70%] p-2 border border-gray-950 rounded" type="text" onChange={setFormData} name="lasttname" placeholder="Prénoms" />
            </div>
            <div className="input-type">
            ...
            <div className="input-type">
                <input className="w-[40%] p-2 border border-gray-950 rounded" type="text" onChange={setFormData} name="number" placeholder="Nombre de vêtements" />
            </div>
            <div className="input-type">
            ...
            <div className="input-type">
                <input className="w-[40%] p-2 border border-gray-950 rounded" type="text" onChange={setFormData} name="phone" placeholder="Numéro de téléphone" />
            </div>

            <br />

            <button className="flex justify-center text-md w-2/6 bg-yellow-500 text-white px-4 py-2 border rounded-md hover:bg-gray-50
            hover:border-yellow-500 hover:text-yellow-500">
                Modifier <span><BiBrush size={25} className="px-1" /></span>
            </button>
