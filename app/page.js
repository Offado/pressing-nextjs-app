  ...
  return (
    <main className="flex min-h-screen flex-col p-6">
      <div className="flex h-20 shrink-0 items-end rounded-lg bg-blue-950 p-4">
        ...
        <p className="text-3xl text-white font-bold px-5">
          AGP-Tech
        </p>
       </div>
       <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          <p className={`${lusitana.className}text-xl text-gray-800 md:text-3xl md:leading-normal`}>
            <strong>Bienvenue à AGP-Tech.</strong> Cette application a été créé pour les propriétaires de pressing pour
            suivre leur activité économique via un ordinateur ou téléphone portable tout en étant à distance de leur local.
          </p>
          <Link
          href="/connexion"
          ...
          >
            <span className="text-xl text-white font-medium">Connexion</span> <FaArrowRightLong size={25} />
          </Link>
        </div>
